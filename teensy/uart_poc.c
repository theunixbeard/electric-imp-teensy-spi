...
// Teensy 2.0: LED is active high
  ...
  #define OUTLET1_CONFIG (DDRF |= (1<<6))
  #define OUTLET2_CONFIG (DDRF |= (1<<7))
  #define OUTLET3_CONFIG (DDRB |= (1<<5))
  #define OUTLET4_CONFIG (DDRD |= (1<<7))

  #define OUTLET1_ON  (PORTF |= (1<<6))
  #define OUTLET1_OFF (PORTF &= ~(1<<6))
  #define OUTLET2_ON  (PORTF |= (1<<7))
  #define OUTLET2_OFF (PORTF &= ~(1<<7))
  #define OUTLET3_ON  (PORTB |= (1<<5))
  #define OUTLET3_OFF (PORTB &= ~(1<<5))
  #define OUTLET4_ON  (PORTD |= (1<<7))
  #define OUTLET4_OFF (PORTD &= ~(1<<7))
